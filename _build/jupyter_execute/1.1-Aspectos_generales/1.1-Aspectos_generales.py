...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Complejidad-de-algoritmos" data-toc-modified-id="Complejidad-de-algoritmos-0">Complejidad de algoritmos</a></span><ul class="toc-item"><li><span><a href="#¿Qué-es-un-algoritmo?" data-toc-modified-id="¿Qué-es-un-algoritmo?-0.1">¿Qué es un algoritmo?</a></span></li><li><span><a href="#Notación-Big-O" data-toc-modified-id="Notación-Big-O-0.2">Notación <em>Big-O</em></a></span></li><li><span><a href="#Serie-de-Fibonacci-y-complejidad-exponencial" data-toc-modified-id="Serie-de-Fibonacci-y-complejidad-exponencial-0.3">Serie de Fibonacci y complejidad exponencial</a></span></li><li><span><a href="#Notación-Big-O-y-tiempo-de-computación" data-toc-modified-id="Notación-Big-O-y-tiempo-de-computación-0.4">Notación <em>Big-O</em> y tiempo de computación</a></span></li></ul></li><li><span><a href="#Representación-binaria-y-errores-de-reondeo" data-toc-modified-id="Representación-binaria-y-errores-de-reondeo-1">Representación binaria y errores de reondeo</a></span><ul class="toc-item"><li><span><a href="#Redondeo-en-variables-tipo-float" data-toc-modified-id="Redondeo-en-variables-tipo-float-1.1">Redondeo en variables tipo <code>float</code></a></span></li><li><span><a href="#Errores-de-redondeo-en-variables-tipo-float" data-toc-modified-id="Errores-de-redondeo-en-variables-tipo-float-1.2">Errores de redondeo en variables tipo <code>float</code></a></span></li><li><span><a href="#Acumulacion-de-errores-de-reondeo" data-toc-modified-id="Acumulacion-de-errores-de-reondeo-1.3">Acumulacion de errores de reondeo</a></span></li></ul></li><li><span><a href="#Identificación-de-errores-y-debugging" data-toc-modified-id="Identificación-de-errores-y-debugging-2">Identificación de errores y debugging</a></span></li><li><span><a href="#Referencias" data-toc-modified-id="Referencias-3">Referencias</a></span></li></ul></div>
